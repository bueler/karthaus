% HALFARMOVIE   Create PNG figures which form the Halfar solution movie shown
% in the lecture.  Naming of files allows "animate" LaTeX package to read the
% figures from the anim/ directory.
