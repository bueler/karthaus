...
% for N&R: cite Roache; also ISMIP-HOM as example of 2
...
% EXERCISE: as first part of below derivation of van der Veen solution, note $(H^2)_x = 2 H H_x$
...
% EXERCISE: make those modifications
...
%N&R  In fact the Newton iteration is a superior alternative \cite{Kelley}
...
\subsubsection*{Realistic ice shelf modeling}  Real ice shelves have two horizontal variables.  They are frequently confined in bays, generating what is sometimes called ``side drag'', and they have highly-variable velocities across their grounding lines.  Real ice stream have many of the same properties.  Furthermore ice shelves have interesting boundary processes, including high basal melt near grounding lines, marine ice can freeze-on at bottom, and there are all the complexities of real bedrock topography.
