...
\documentclass[letterpaper,final,12pt]{amsart}

%\usepackage[total={6.2in,9.4in},top=1.2in,left=1.05in]{geometry}
\usepackage[total={6.3in,9.2in},top=1.1in,left=0.95in]{geometry}
...
\begin{quote}
\fbox{\url{https://github.com/bueler/karthaus/releases}}
\end{quote}
...
\exer{13}{Derive the surface kinematical equation \eqref{surfkine} from the mass continuity \eqref{masscont} and basal kinematical \eqref{basekine} equations.  Note that the Leibniz rule for differentiating integrals, mentioned in the text, is
