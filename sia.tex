...
\item Newton's law of cooling for each segments of the rod:
\begin{align*}
...
\normalsize
\item the difference between the equation $u_t = D u_{xx}$ and the scheme is $O(\Delta t,\Delta x^2)$
...
\includegraphics[width=0.85\textwidth]{expstencil}
\end{column}
\end{columns}
\end{frame}
...
\bigskip
\begin{center}
\includegraphics[width=1.2\textwidth]{initialheat}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
...
\bigskip
\begin{center}
\includegraphics[width=1.2\textwidth]{finalheat}
\end{center}
\end{column}
\end{columns}
\end{frame}
