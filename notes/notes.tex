...
\twofigsizes{siple}{streamisbrae}{Left:  The SSA model applies to ice streams, like these Siple Coast ice streams in Antarctica, shown by their radar-derived surface velocity.  Right: Figure 1 in \cite{TrufferEchelmeyer} plots cross sections of Jakobshavns Isbrae (above) and Whillans Ice Stream (below) \emph{without} vertical exaggeration.}{2.7in}{3.0in}
